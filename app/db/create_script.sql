...
-- *******       **********      ****************            ******************
-- 01            14-04-2023      Igone van der Kley            New
-- **********************************************************************************/
...
VALUES
    ...
    ,('Youri', 'Van', 'Veen', '06-24383291', '2010-05-12', '***', 1, NULL, SYSDATE(6), SYSDATE(6))
...
,CONSTRAINT FK_VoertuigInstructeur_InstructeurId_Insructeur_Id FOREIGN KEY (InstructeurId) REFERENCES Instructeur(Id)
)ENGINE=InnoDB;
